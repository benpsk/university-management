...
<h2 class="text-center pb-3">University Management System</h2>
<nav class="navbar navbar-expand-lg navbar-light bg-info">
	<div class="container">
		<a class="navbar-brand" href="/UniversitySystem/index.htm"><i
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu btn btn-outline-success"
						...
						<a class="dropdown-item" href="/UniversitySystem/teachList">Teacher
							List </a> <a class="dropdown-item" href="/UniversitySystem/teachForm">Add
							New Teacher</a> <a class="dropdown-item"
							href="/UniversitySystem/manageTeach">Manage Teacher </a>
					</div></li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu btn btn-outline-success"
						...
						<a class="dropdown-item" href="/UniversitySystem/etype/examList">Exam
							...
							href="/UniversitySystem/etype/etypeForm">Add New ExamType </a> <a
							class="dropdown-item" href="/UniversitySystem/etype/manage">
							Manage Exam Type </a>
					</div></li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu btn btn-outline-success"
						...
						<a class="dropdown-item" href="/UniversitySystem/att/show">Record
							...
							href="/UniversitySystem/att/list">Attendance List</a>
					</div></li>
			</ul>
		</div>
	</div>
